        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex gap-4 border-[1px] p-2 shadow-xl'>
            ...
            <div className='flex justify-center items-center w-full'>
             ...
             <input className='w-full outline-none p-2' placeholder='Job title, Keyword...' type="text" />
            </div>
            ...
            <select defaultValue='Select Country' id="country" name="country" class="form-control" className='w-full outline-none p-2'>
            ...
            <button className='p-2 rounded-xl bg-[#0066FF] w-1/2 text-[#Fff]'>Find Job</button>
          </div>
        </div>
        <div>
